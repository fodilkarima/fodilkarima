...
-- Modèle staging : nettoyage et structuration des données démographiques INSEE
select
 -- Nom de la région
  C1::string as region,
   -- Ajout manuel de l'année correspondant au fichier
  2022 as year_path_started,
    -- Nettoyage des valeurs hommes :
 -- suppression des caractères non numériques puis conversion en nombre
...
-- Source brute chargée dans Snowflake
from {{ source('ecommerce', 'population_2022') }}
-- Filtrage des lignes inutiles du fichier CSV (titres, sources, notes)
